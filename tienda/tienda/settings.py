...
#    En mi caso con la cuenta reciénmbre personalizado)" y escibir "faithfulpet" (nombre de mi aplicación) creada "info.faithfulpet@gmail.com" y contraseña "Faith@fulpet@1990"
# 7. En combobox "Seleccionar app" escoger "Otra (no
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'info.ofertas.tienda@gmail.com'  # Reemplaza con tu dirección de correo Gmail
EMAIL_HOST_PASSWORD = 'docvhktemcmqoozf ' # Reemplaza con tu contraseña de "aplicación generada"
